        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre",
                    models.CharField(
                        help_text="Nombre con el que la categoría será identificada",
                        max_length=100,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "portada",
                    models.ImageField(
                        blank=True, null=True, upload_to="cursos/portadas/"
                    ),
                ),
                (
                    "nombre",
                    models.CharField(
                        help_text="Nombre con el que el curso será identificado",
                        max_length=200,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Presentación del curso",
                        null=True,
                        verbose_name="Presentación del curso",
                    ),
                ),
                (
                    "nivel",
                    models.CharField(
                        ...
                        help_text="Selecciona el nivel del curso",
                        max_length=20,
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Número de estudiantes inscritos en el curso",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="%(class)s_categoria",
                        to="cursos.categoriasmodel",
